...
$$x^n=\begin{bmatrix}x_1\\x_2\end{bmatrix}$$

$$\phi(x_n)=\begin{bmatrix}x^2_1 \\ x_1x_2 \\ x^2_2 \end{bmatrix}$$
...
$$(u^\top v)^2=(\sum^2_{i=1}u_iv_i)(\sum^2_{j=1}u_jv_j)$$

$$=\sum^2_{i=1}\sum^2_{j=1}(u_iu_j)(v_iv_j)=\begin{bmatrix}u^2_1 & u_1u_2 & u_2u_1 & u^2_2\end{bmatrix}\begin{bmatrix}v^2_1 \\ v_1v_2 \\ v_2v_1 \\ v^2_2\end{bmatrix}$$

- So if we define $\phi$ as 

$$u=\begin{bmatrix}u_1 \\ u_2 \end{bmatrix}$$

$$\phi(u)=\begin{bmatrix}u^2_1 \\ u_1u_2 \\ u_2u_1 \\ u^2_2 \end{bmatrix}$$
...
<center><img src="https://kr.object.ncloudstorage.com/paper-review/week1/week1_figure4.png" width="50%" height="50%"/></center>
...
<center><img src="https://kr.object.ncloudstorage.com/paper-review/week1/week1_figure5.png" width="70%" height="70%"/></center>
...
<center><img src="https://kr.object.ncloudstorage.com/paper-review/week1/week1_figure6.png" width="90%" height="90%"/></center>
...
<center><img src="https://kr.object.ncloudstorage.com/paper-review/week1/week1_figure7.png" width="90%" height="90%"/></center>
